...
public class GetAllCityQueryHandler
        implements  QueryUseCase<CityQueryRequest, PageResult<City>> {
    ...
    @Override
    public Mono<PageResult<City>> query(CityQueryRequest request, String token) {
     ...
     */
    private String buildSortString(CityQueryRequest request) {
